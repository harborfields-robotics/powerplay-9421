 ...
 */
@Autonomous(name="Blue One Ring", group="Linear Opmode")

public class ParkAuto_Copy extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        br.setPower(0); 
        fr.setPower(0); 
        shooter1.setPower(-.85); 
        shooter2.setPower(-.85); 
        shooterAngle.setPosition(.55); 
        ringBlocker.setPosition(.2); 
        sleep(1500);
